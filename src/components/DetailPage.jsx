    ...
    <main className="detail-page">
      ...
      <div className="detail-body page-width">
        <div className="detail-main">
            {item.fullDescription && <section className="detail-overview"><span className="eyebrow">Overview</span><h2>{type === "stay" ? "About this accommodation" : "More to discover"}</h2><p>{item.fullDescription}</p></section>}
          ...
          <section className="detail-information"><span className="eyebrow">Useful information</span><h2>{type === "food" ? "Before you request a table" : type === "nightlife" ? "Before you head out" : "Before you make plans"}</h2>{usefulInfo.length ? <ul>{usefulInfo.map((info) => <li key={info}>{info}</li>)}</ul> : <p>Ask Visit Malindi for the latest information before arranging this.</p>}</section>
