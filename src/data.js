...
const foodEntries = [
  { id: "restaurants", slug: "restaurants-in-malindi", name: "Restaurants in Malindi", category: "Restaurants", location: "Malindi", image: photos.dining, description: "A starting point for deciding where to eat in Malindi, with local recommendations based on your plans and preferences." },
  ...
  { id: "fine-dining", slug: "fine-dining", name: "Fine dining", category: "Fine Dining", location: "Malindi & Watamu", image: photos.sunset, description: "For a more considered evening meal, ask Visit Malindi for current local recommendations." },
  { id: "beach-restaurants", slug: "beach-restaurants", name: "Beach restaurants", category: "Beach Restaurants", location: "Malindi & Watamu", image: photos.beach, description: "Plan a meal with sea air and an easy coast setting, with current suggestions from the concierge." },
  { id: "bars", slug: "bars-on-the-coast", name: "Bars on the coast", category: "Bars", location: "Malindi & Watamu", image: photos.sunset, description: "Find a relaxed place for a drink before dinner or as the evening begins." },
  { id: "casual-dining", slug: "casual-dining", name: "Casual dining", category: "Casual Dining", location: "Malindi & Watamu", image: photos.dining, description: "Easy, flexible food options for visitors who want to keep the day moving." },
];

const nightlifeEntries = [
  { id: "clubs", slug: "clubs-in-malindi", name: "Clubs in Malindi", category: "Clubs", location: "Malindi", image: photos.night, description: "Ask a local about the current after-dark options for visitors who want a livelier evening." },
  { id: "bars-nightlife", slug: "nightlife-bars", name: "Nightlife bars", category: "Bars", location: "Malindi & Watamu", image: photos.sunset, description: "Cocktails, sea air and a relaxed start to the evening." },
  { id: "beach-lounges", slug: "beach-lounges", name: "Beach lounges", category: "Lounges", location: "Malindi & Watamu", image: photos.sunset, description: "A slower coast evening with sea air and room to settle in." },
  { id: "beach-nightlife", slug: "beach-nightlife", name: "Beach nightlife", category: "Beach Nightlife", location: "Malindi & Watamu", image: photos.beach, description: "Ask what is currently happening by the beach while you are in town." },
  ...
  { id: "dj-events", slug: "dj-events", name: "DJ events", category: "DJ Events", location: "Malindi", image: photos.night, description: "For the current DJ calendar, ask Visit Malindi what is happening during your stay." },
  { id: "parties", slug: "parties", name: "Parties", category: "Parties", location: "Malindi & Watamu", image: photos.beach, description: "Look for current parties and special nights through the concierge rather than relying on old information." },
  { id: "entertainment", slug: "evening-entertainment", name: "Evening entertainment", category: "Entertainment", location: "Malindi & Watamu", image: photos.night, description: "A broad starting point for deciding how to spend the evening on the coast." },
];
