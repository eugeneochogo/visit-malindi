...
const catalogueByRoute = {
  ...
  "/things-to-do-in-malindi": { title: "Things to do in Malindi", eyebrow: "Explore", intro: "Make your time on the Kenyan Coast count with marine, nature, culture and adventure experiences.", data: experiences, type: "experience", filters: ["All", "Marine", "Nature", "History & Culture", "Adventure"], matches: (item) => item.location.includes("Malindi") },
  "/things-to-do-in-watamu": { title: "Things to do in Watamu", eyebrow: "Explore", intro: "Explore water, nature, mangroves, history and easy coast days on the Watamu side of your trip.", data: experiences, type: "experience", filters: ["All", "Marine", "Nature", "History & Culture", "Adventure"], matches: (item) => item.location.includes("Watamu") },
  "/malindi-excursions": { title: "Malindi excursions", eyebrow: "Explore", intro: "Local ideas for getting out on the water, into nature and closer to the coast.", data: experiences, type: "experience", filters: ["All", "Marine", "Nature", "History & Culture", "Adventure"], matches: (item) => item.location.includes("Malindi") },
